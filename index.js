...
let left_list1 = document.getElementById('left_list11');
let right_list1 = document.getElementById('right_list11');

let lists1 = document.getElementsByClassName('list1')[0];

left_list1.addEventListener('click', () => {
    lists1.scrollLeft -= 100;
});

right_list1.addEventListener('click', () => {
    lists1.scrollLeft += 100;
});
...
// let side = document.getElementById('sideOne');
...
// contain.addEventListener('load', function(e){
//     e.preventDefault();
// })
...
setTimeout(() => log.location.href = "LogIn.html", 4000);
...
scrollRevealOption().reveal('.maroc img', {
    ...scrollRevealOption,
    origin: 'right',
});